...
if ( ! class_exists( 'E_Register_NowPUE__Plugin_Info' ) ) {
	/**
	 * A container class for holding and transforming various plugin metadata.
	 * @version 1.7
	 * @access public
	 */
	class E_Register_NowPUE__Plugin_Info {
		...
		/**
		 * Create a new instance of E_Register_NowPUE__Plugin_Info from JSON-encoded plugin info
		 * returned by an external update API.
		 *
		 * @param string $json Valid JSON string representing plugin info.
		 *
		 *@return E_Register_NowPUE__Plugin_Info New instance of E_Register_NowPUE__Plugin_Info, or NULL on error.
		 */
		public static function from_json( $json ) {
			...
			$info = new E_Register_NowPUE__Plugin_Info();
