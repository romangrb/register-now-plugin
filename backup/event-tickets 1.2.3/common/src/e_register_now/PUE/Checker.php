...
if ( ! class_exists( 'E_Register_NowPUE__Checker' ) ) {
	/**
	 ...
	 * @access   public
	 */
	class E_Register_NowPUE__Checker {
		...
		public function request_info( $queryArgs = array() ) {
			...
			if ( ! is_wp_error( $result ) && isset( $result['response']['code'] ) && ( $result['response']['code'] == 200 ) && ! empty( $result['body'] ) ) {
				$pluginInfo = E_Register_NowPUE__Plugin_Info::from_json( $result['body'] );
			}
		 ...
		 *
		 * @uses E_Register_NowPUE__Checker::request_info()
		 *
		 * @return E_Register_NowPUE__Utility An instance of E_Register_NowPUE__Utility, or NULL when no updates are available.
		 */
		public function request_update() {
			...
			return E_Register_NowPUE__Utility::from_plugin_info( $pluginInfo );
		}
		 ...
		 * successfully, the first argument passed will be an instance of E_Register_NowPUE__Plugin_Info. Otherwise,
		 * it will be NULL. The second argument will be the corresponding return value of
		 * wp_remote_get (see WP docs for details).
		 *
		 * The callback function should return a new or modified instance of E_Register_NowPUE__Plugin_Info or NULL.
		 *
		 * @uses add_filter() This method is a convenience wrapper for add_filter().
		 *
		 * @param callback $callback
