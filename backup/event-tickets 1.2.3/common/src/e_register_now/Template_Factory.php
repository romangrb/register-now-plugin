...
if ( class_exists( 'E_Register_NowTemplate_Factory' ) ) {
	return;
}

class E_Register_NowTemplate_Factory {
	 ...
	 * @param E_Register_NowMain         $tec           An instance of the main plugin class
	 */
	 ...
	 *
	 * @param object              $asset         The E_Register_Now*Asset object
	 * @param string              $name          The asset name in the `hyphen-separated-format`
	 * @param array               $deps          An array of dependency handles
	 * @param string              $vendor_url    URL to vendor scripts and styles dir
	 * @param string              $prefix        MT script and style prefix
	 * @param E_Register_NowMain         $common        An instance of the main plugin class
	 */
	...
	protected static function get_asset_factory_instance( $name ) {
		$asset = E_Register_NowAsset__Factory::instance()->make_for_name( $name );
		return $asset;
	}
	...
	public static function asset_package( $name, $deps = array() ) {
		...
		$common = E_Register_NowMain::instance();
		$prefix = 'tribe-events';
