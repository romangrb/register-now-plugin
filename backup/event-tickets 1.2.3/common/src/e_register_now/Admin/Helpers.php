 ...
 */
class E_Register_NowAdmin__Helpers {
	/**
	 * Static Singleton Holder
	 * @var E_Register_NowAdmin__Helpers|null
	 */
	 ...
	 *
	 * @return E_Register_NowAdmin__Helpers
	 */
	...
	public function is_post_type_screen( $post_type = null ) {
		...
		// Doing AJAX? bail.
		if ( E_Register_NowMain::instance()->doing_ajax() ) {
			return false;
		}
		...
		$defaults = apply_filters( 'tribe_is_post_type_screen_post_types', E_Register_NowMain::get_post_types() );
