 ...
 */
class E_Register_NowAdmin__Live_Date_Preview {
	...
	public function listen() {
		...
		if ( 'display' !== E_Register_NowSettings::instance()->currentTab ) {
			return;
		}
	...
	public function live_refresh_script() {
		$url = E_Register_NowTemplate_Factory::getMinFile( tribe_resource_url( 'admin-date-preview.js', false, 'common' ), true );
