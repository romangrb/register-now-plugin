 ...
 *
 */
class E_Register_NowAdmin__Help_Page {
	/**
	 * Static Singleton Holder
	 * @var E_Register_NowAdmin__Help_Page|null
	 */
	 ...
	 *
	 * @return E_Register_NowAdmin__Help_Page
	 */
	...
	public function get_plugins( $plugin_name = null, $is_active = true ) {
		...
		if ( class_exists( 'E_Register_NowEvents__Main' ) ) {
			$plugins['the-events-calendar']['version'] = E_Register_NowEvents__Main::VERSION;
		...
		if ( class_exists( 'E_Register_NowTickets__Main' ) ) {
			$plugins['event-tickets']['version'] = E_Register_NowTickets__Main::VERSION;
	...
	public function get_addons( $plugin = null, $is_active = null, $is_important = null ) {
		...
		$addons['events-calendar-pro'] = array(
			...
			'is_active' => class_exists( 'E_Register_NowEvents__Pro__Main' ),
			'is_important' => true,
		);
		...
		$addons['eventbrite-tickets'] = array(
			...
			'plugin' => array( 'the-events-calendar' ),
			'is_active' => class_exists( 'E_Register_NowEvents__Tickets__Eventbrite__Main' ),
		);
		...
		$addons['community-events'] = array(
			...
			'plugin' => array( 'the-events-calendar' ),
			'is_active' => class_exists( 'E_Register_NowEvents__Community__Main' ),
		);
		...
		$addons['facebook-events'] = array(
			...
			'plugin' => array( 'the-events-calendar' ),
			'is_active' => class_exists( 'E_Register_NowEvents__Facebook__Importer' ),
		);
		...
		$addons['events-filter-bar'] = array(
			...
			'plugin' => array( 'the-events-calendar' ),
			'is_active' => class_exists( 'E_Register_NowEvents__Filterbar__View' ),
		);
		...
		$addons['event-tickets-plus'] = array(
			...
			'is_active' => class_exists( 'E_Register_NowTickets_Plus__Main' ),
			'is_important' => true,
		);
		...
		$addons['event-community-tickets'] = array(
			...
			'plugin' => array( 'event-tickets' ),
			'is_active' => class_exists( 'E_Register_NowEvents__Community__Tickets__Main' ),
		);
	...
	public function get_ga_link( $link = null, $relative = true ) {
		...
		if ( true === $relative ) {
			$link = trailingslashit( E_Register_NowMain::$tec_url . $link );
		}
	...
	public function get_feed_items() {
		$news_rss = fetch_feed( E_Register_NowMain::FEED_URL );
		$news_feed = array();
	...
	public function get_sections( $print = true ) {
		 ...
		 *
		 * @var E_Register_NowAdmin__Help_Page
		 */
