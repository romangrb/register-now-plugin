...
/**
 * Class E_Register_NowAdmin__Notice__Archive_Slug_Conflict
 *
...
class E_Register_NowAdmin__Notice__Archive_Slug_Conflict {
	...
	/**
	 * @return E_Register_NowAdmin__Notice__Archive_Slug_Conflict
	 */
	...
	public function maybe_add_admin_notice() {
		$this->archive_slug = E_Register_NowSettings_Manager::get_option( 'eventsSlug', 'events' );
