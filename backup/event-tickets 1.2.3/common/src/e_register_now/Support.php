...
if ( ! class_exists( 'E_Register_NowSupport' ) ) {

	class E_Register_NowSupport {

		public static $support;
		public $rewrite_rules_purged = false;

		/**
		 * @var E_Register_NowSupport__Obfuscator
		 */
		 ...
		 * @param E_Register_NowAdmin__Help_Page $help The Help Page Instance
		 */
		public function append_system_info( E_Register_NowAdmin__Help_Page $help ) {
		...
		public function getSupportStats() {
			...
			$systeminfo = array(
				...
				'settings'           => E_Register_NowSettings_Manager::get_options(),
		 ...
		 *
		 * @param E_Register_NowSupport__Obfuscator $obfuscator
		 */
		public function set_obfuscator( E_Register_NowSupport__Obfuscator $obfuscator ) {
		...
		public static function getInstance() {
			if ( null == self::$instance ) {
				$instance       = new self;
				$instance->set_obfuscator( new E_Register_NowSupport__Obfuscator( $instance->must_obfuscate_prefixes ) );
