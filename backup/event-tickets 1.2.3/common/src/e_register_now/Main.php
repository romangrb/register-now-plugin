...
if ( class_exists( 'E_Register_NowMain' ) ) {
	return;
}

class E_Register_NowMain {
	...
	protected function init_autoloading() {
		...
		$prefixes = array( 'E_Register_Now' => dirname( __FILE__ ) );
	...
	public function add_hooks() {
		add_action( 'plugins_loaded', array( 'E_Register_NowApp_Shop', 'instance' ) );
	...
	public function admin_enqueue_scripts() {
		...
		$helper = E_Register_NowAdmin__Helpers::instance();
