 ...
 */
class E_Register_NowLog__Null_Logger implements E_Register_NowLog__Logger{
	 ...
	 * @param string $src
	 */
	public function log( $entry, $type = E_Register_NowLog::DEBUG, $src = '' ) {
		// no-op
	}
	 ...
	 *
	 * @see E_Register_NowLog__Logger::list_available_logs()
	 *
	 * @param int   $limit
	 * @param array $args
	 *
