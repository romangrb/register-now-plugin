...
/**
 * Class E_Register_NowException
 *
 * Handles exceptions to log when not in debug mode.
 */
class E_Register_NowException extends Exception {
	...
	/**
	 * E_Register_NowException constructor.
	 *
	...
	private function get_log_type_for_exception_code( $code ) {
		...
		return isset( $map[ $code ] ) ? $map[ $code ] : E_Register_NowLog::ERROR;
	}
	 ...
	 *
	 * @see E_Register_NowException::handle()
	 *
	 * @throws Exception
	 */
