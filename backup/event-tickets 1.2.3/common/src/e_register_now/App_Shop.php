...
if ( ! class_exists( 'E_Register_NowApp_Shop' ) ) {
	/**
	 * Class that handles the integration with our Shop App API
	 */
	class E_Register_NowApp_Shop {
		 ...
		 * Singleton instance
		 *
		 * @var null or E_Register_NowApp_Shop
		 */
		...
		public function add_menu_page() {
			if ( ! E_Register_NowSettings::instance()->should_setup_pages() ) {
				return;
			}
			...
			$where = E_Register_NowSettings::instance()->get_parent_slug();
		...
		public function add_toolbar_item() {
			...
			if ( current_user_can( $capability ) ) {
				...
				$wp_admin_bar->add_menu( array(
					...
					'href'   => E_Register_NowSettings::instance()->get_url( array( 'page' => self::MENU_SLUG ) ),
		...
		public function enqueue() {
			wp_enqueue_style( 'app-shop', tribe_resource_url( 'app-shop.css', false, 'common' ), array(), apply_filters( 'tribe_events_css_version', E_Register_NowMain::VERSION ) );
			wp_enqueue_script( 'app-shop', tribe_resource_url( 'app-shop.js', false, 'common' ), array(), apply_filters( 'tribe_events_js_version', E_Register_NowMain::VERSION ) );
		}
		...
		public function do_menu_page() {
			...
			include_once E_Register_NowMain::instance()->plugin_path . 'src/admin-views/app-shop.php';
		}
