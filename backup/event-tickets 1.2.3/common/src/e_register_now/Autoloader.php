<?php
	...
	if ( ! class_exists( 'E_Register_NowAutoloader' ) ) {
		/**
		 * Class E_Register_NowAutoloader
		 *
		 ...
		 *      $autoloader = E_Register_NowAutoloader::instance();
		 *
		 *      // register one by one or use `register_prefixes` method
		 *      $autoloader->register_prefix( 'E_Register_NowAdmin__', $this_dir . '/src/e_register_now/admin' );
		 *      $autoloader->register_prefix( 'E_Register_NowAdmin__', $this_dir . '/src/e_register_now/another-dir' );
		 *      $autoloader->register_prefix( 'E_Register_NowUtils__', $this_dir . '/src/e_register_now/another-dir' );
		 *
		 *      // register a direct class to path
		 *      $autoloader->register_class( 'E_Register_NowSome_Class', $this_dir . '/some/path/to/Some_Class.php' );
		 *
		...
		class E_Register_NowAutoloader {
			 ...
			 *
			 * @return E_Register_NowAutoloader
			 */
			public static function instance() {
				if ( ! self::$instance instanceof E_Register_NowAutoloader ) {
			 ...
			 *
			 * @param string $prefix   A class prefix, e.g. `E_Register_NowAdmin__`
