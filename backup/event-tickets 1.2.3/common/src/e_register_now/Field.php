		...
		public function doField() {
			...
			if ( $this->conditional ) {
				...
				if ( $this->display_callback && is_callable( $this->display_callback ) ) {
					...
					// fail, log the error
					E_Register_NowMain::debug( esc_html__( 'Invalid field type specified', 'tribe-common' ), $this->type, 'notice' );
