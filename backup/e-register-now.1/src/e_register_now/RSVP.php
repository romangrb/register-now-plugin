...
class E_Register_Now__Tickets__RSVP extends E_Register_Now__Tickets__Tickets {
	...
	public function enqueue_resources() {
		...
		$user_stylesheet_url = E_Register_Now__Templates::locate_stylesheet( 'e-rn-events/tickets/rsvp.css' );

		// If override stylesheet exists, then enqueue it
		if ( $user_stylesheet_url ) {
			wp_enqueue_style( 'e-rn-events-tickets-rsvp-override-style', $user_stylesheet_url );
		}
	}
