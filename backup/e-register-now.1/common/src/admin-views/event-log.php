 ...
 */
?>
<div id="e-rn-log-controls">

	<?php
	/**
	 * Fires within the #e-rn-log-controls div, before any of the default
	...
	<div>
		<label for="log-levels"><?php esc_html_e( 'Logging level', 'e-rn-common' ) ?></label>
	...
	<?php
	/**
	 * Fires within the #e-rn-log-controls div, after the #log-level control.
	 */
	do_action( 'e_rn_common_log_controls_after_log_level' );
	?>

	<div>
		<label for="log-engine"><?php esc_html_e( 'Method', 'e-rn-common' ) ?></label>
	...
	<?php
	/**
	 * Fires within the #e-rn-log-controls div, after the #log-engine control.
	 */
	do_action( 'e_rn_common_log_controls_after_log_engine' );
	?>

	<div>
		<label for="log-selector"><?php esc_html_e( 'View', 'e-rn-common' ) ?></label>
	...
	<?php
	/**
	 * Fires within the #e-rn-log-controls div, after the #log-selector control.
	 */
	...
	<?php
	/**
	 * Fires within the #e-rn-log-controls div, after all of the default
...
<div id="e-rn-log-viewer">
	...
	<?php if ( empty( $log_entries ) ): ?>
		<p><?php esc_html_e( 'The selected log file is empty or has not been generated yet.', 'e-rn-common' ); ?></p>
	<?php endif; ?>

</div>

<p> <a href="<?php echo esc_url( $download_url ) ?>" class="download_log" target="_blank"><?php esc_html_e( 'Download log', 'e-rn-common' ); ?> </a> </p>