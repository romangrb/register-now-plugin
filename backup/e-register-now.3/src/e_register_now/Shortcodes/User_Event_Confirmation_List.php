 ...
 *
 *     [e-rn-user-event-confirmations]
 *
 * Example specifying a user:
 *
 *     [e-rn-user-event-confirmations user="512"]
 *
 * Example specifying a limit to the number of events which should be returned:
 *
 *     [e-rn-user-event-confirmations limit="16"]
 */
class E_Register_Now__Tickets__Shortcodes__User_Event_Confirmation_List {
	 ...
	 * name (or else defaults to "e-rn-user-event-confirmations").
	 *
	 * @param string $shortcode_name
	 */
	public function __construct( $shortcode_name = 'e-rn-user-event-confirmations' ) {
		/**
