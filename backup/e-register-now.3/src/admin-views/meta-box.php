...
<table id="event_tickets" class="eventtable">
	<?php
	wp_nonce_field( 'e-rn-tickets-meta-box', 'e-rn-tickets-post-settings' );
	...
	<tr class="event-wide-settings">
		<td colspan="2" class="e_rn_sectionheader updated">
			<table class="eventtable ticket_list eventForm">
				<tr class="e-rn-tickets-image-upload">
					<td>
				...
				<tr class="e-rn-tickets-image-preview">
					<td colspan="2">
	...
	<?php if ( $show_global_stock ): ?>
		<tr id="e-rn-global-stock-settings" class="event-wide-settings">
			<td colspan="2">
				<table class="eventtable ticket_list eventForm">
					<tr>
						<td>
							<label for="e-rn-tickets-enable-global-stock">
								<?php esc_html_e( 'Enable global stock', 'event-tickets' ); ?>
							</label>
						</td>
						<td>
							<input type="checkbox" name="e-rn-tickets-enable-global-stock" id="e-rn-tickets-enable-global-stock" value="1" <?php checked( $global_stock->is_enabled() ); ?> />
						</td>
					</tr>
					<tr id="e-rn-tickets-global-stock-level">
						<td>
							<label for="e-rn-tickets-global-stock">
								<?php esc_html_e( 'Global stock level', 'event-tickets' ); ?>
							</label>
						</td>
						<td>
							<input type="number" name="e-rn-tickets-global-stock" id="e-rn-tickets-global-stock" value="<?php echo esc_attr( $global_stock->get_stock_level() ); ?>" />
							<span class="e-rn-tickets-global-sales">
	...
	<tr id="ticket_form" class="ticket_form">
		<td colspan="2" class="e_rn_sectionheader">
			<div id="e-rn-loading"><span></span></div>
