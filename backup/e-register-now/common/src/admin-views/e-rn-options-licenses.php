...
if ( is_multisite() ) {
	$network_all_sites_text = sprintf(
		esc_html__( '%1$s Using our plugins in a multisite network? %2$s Please note that your license key will be applied to the entire network, not just this site.', 'e-rn-common' ),
		'<strong>',
		'</strong>'
	);
...
$licenses_tab = array(
	...
	'info-box-title' => array(
		'type' => 'html',
		'html' => '<h2>' . esc_html__( 'Licenses', 'e-rn-common' ) . '</h2>',
	),
