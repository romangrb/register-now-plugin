jQuery( document ).ready( function( $ ) {
	...
	$( '.e-rn-attendees-email' ).on({
		'submit': function( event ) {
			$( '.e-rn-attendees-email' ).hide();
			$( document.getElementById( 'e-rn-loading' ) ).show();
		}
	});
	...
	$( '.tickets_checkin' ).click( function( e ) {
		...
		var params = {
			action  : 'e-rn-ticket-checkin-' + obj.attr( 'data-provider' ),
	...
	$( '.tickets_uncheckin' ).click( function( e ) {
		...
		var params = {
			action  : 'e-rn-ticket-uncheckin-' + obj.attr( 'data-provider' ),
			provider: obj.attr( 'data-provider' ),
			order_ID: obj.attr( 'data-attendee-id' ),
