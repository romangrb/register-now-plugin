...
if ( ! class_exists( 'Register_In_One_Click__PUE__Plugin_Info' ) ) {
	/**
	 * A container class for holding and transforming various plugin metadata.
	 * @version 1.7
	 * @access public
	 */
	class Register_In_One_Click__PUE__Plugin_Info {
		...
		/**
		 * Create a new instance of Register_In_One_Click__PUE__Plugin_Info from JSON-encoded plugin info
		 * returned by an external update API.
		 *
		 * @param string $json Valid JSON string representing plugin info.
		 *
		 *@return Register_In_One_Click__PUE__Plugin_Info New instance of Register_In_One_Click__PUE__Plugin_Info, or NULL on error.
		 */
		public static function from_json( $json ) {
			...
			$info = new Register_In_One_Click__PUE__Plugin_Info();
