...
if ( ! class_exists( 'Register__Now__Support' ) ) {

	class Register__Now__Support {

		public static $support;
		public $rewrite_rules_purged = false;

		/**
		 * @var Register__Now__Obfuscator
		 */
		 ...
		 * @param Register__Now__Admin__Help_Page $help The Help Page Instance
		 */
		public function append_system_info( Register__Now__Admin__Help_Page $help ) {
