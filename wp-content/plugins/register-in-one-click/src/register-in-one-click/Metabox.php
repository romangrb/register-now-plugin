...
class Register_In_One_Click__Tickets__Metabox {
	...
	public static function maybe_add_meta_box( $post_type ) {
		...
		add_meta_box(
			'tribetickets',
			esc_html__( 'Tickets', 'e-RegisterNow' ),
			array(
	...
	public static function add_admin_scripts( $hook ) {
		...
		// wp_register_script( 'event-tickets-time-validation', $resources_url .'/js/tickets-time-validation.js', array('jQuery'), Register_In_One_Click__Tickets__Main::instance()->js_version(), true );
		...
		wp_enqueue_script( 'event-tickets-creator', $resources_url .'/js/ticket-creator.js', array(), Register_In_One_Click__Tickets__Main::instance()->js_version(), true );
		wp_enqueue_script( 'event-fields-operator', $resources_url .'/js/fields-op.js', array(), Register_In_One_Click__Tickets__Main::instance()->js_version(), true );
