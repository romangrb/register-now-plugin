			...
			*/
			...
			if ( $return ) {
				...
				$return = (! $is_required_data_empty) ? 
					...
					$this->notice( esc_html__( 'The event has been saved as draft (some of required fields were autogenerated by prefix - auto_ ... , it could be changed). Please fill all required fields in form', 'event-tickets' ) . $return, 'notice notice-warning is-dismissible');
				/**
