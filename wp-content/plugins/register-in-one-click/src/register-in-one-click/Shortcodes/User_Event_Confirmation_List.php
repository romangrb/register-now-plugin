 ...
 *
 *     [rioc-user-event-confirmations]
 *
 * Example specifying a user:
 *
 *     [rioc-user-event-confirmations user="512"]
 *
...
class E_Register_Now__Tickets__Shortcodes__User_Event_Confirmation_List {
	 ...
	 * name (or else defaults to "rioc-user-event-confirmations").
	 *
	 * @param string $shortcode_name
	 */
	public function __construct( $shortcode_name = 'rioc-user-event-confirmations' ) {
		/**
