...
class Register_In_One_Click__Tickets__Tickets_Handler {
	...
	public function attendees_page_screen_setup() {
		...
		if ( ! empty( $_GET['action'] ) && in_array( $_GET['action'], array( 'email' ) ) ) {
			...
			if ( isset( $_POST['rioc-send-email'] ) && $_POST['rioc-send-email'] ) {
	...
	public function save_image_header( $post_id ) {
		if ( ! ( isset($_POST[ 'rioc-tickets-post-settings' ])  && wp_verify_nonce( $_POST[ 'rioc-tickets-post-settings' ], 'rioc-tickets-meta-box' ) ) ) {
			return;
		}
