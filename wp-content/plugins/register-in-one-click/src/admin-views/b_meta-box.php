	...
	<tr id="ticket_form" class="ticket_form">
		<td colspan="2" class="rioc_sectionheader">
			...
			<table class="eventtable ticket_form">
				<tr>
					<td colspan="2">
						<h4 class="ticket_form_title_add"><?php esc_html_e( 'Add new event', 'event-tickets' ); ?></h4>
						<h4 class="ticket_form_title_edit"><?php esc_html_e( 'Edit event', 'rioc-event' ); ?></h4>
				...
				<div>
					...
					<ul class="rioc-tab-buttons" id="rioc-slider-toolbar">
						<li class="laststep"><input type="hidden" name="ticket_id" id="ticket_id" class="ticket_field" value="" /></input></li>
