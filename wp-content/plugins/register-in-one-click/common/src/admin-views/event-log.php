...
<div id="rioc-log-controls">
	...
	<div>
		<label for="log-selector"><?php esc_html_e( 'View', 'rioc-common' ) ?></label>
...
<div id="rioc-log-viewer">
	...
	<?php if ( empty( $log_entries ) ): ?>
		<p><?php esc_html_e( 'The selected log file is empty or has not been generated yet.', 'rioc-common' ); ?></p>
	<?php endif; ?>

</div>

<p> <a href="<?php echo esc_url( $download_url ) ?>" class="download_log" target="_blank"><?php esc_html_e( 'Download log', 'rioc-common' ); ?> </a> </p>