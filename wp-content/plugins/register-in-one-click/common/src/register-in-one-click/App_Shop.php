...
if ( ! class_exists( 'Register_In_One_Click__App_Shop' ) ) {
	...
	class Register_In_One_Click__App_Shop {
		...
		private function get_all_products() {
			$products = array(
				(object) array(
					'title' => __( 'Filter Bar', 'rioc-common' ),
					...
					'description' => __( 'It is awesome that your calendar is <em>THE PLACE</em> to get hooked up with prime choice ways to spend time. You have more events than Jabba the Hutt has rolls. Too bad visitors are hiring a personal assistant to go through all the choices. Ever wish you could just filter the calendar to only show events in walking distance, on a weekend, that are free? BOOM. Now you can. Introducing… the Filter Bar.', 'rioc-common' ),
					'image' => 'images/app-shop-filter-bar.jpg',
				),
				(object) array(
					'title' => __( 'Events Calendar PRO', 'rioc-common' ),
					...
					'description' => sprintf(
						__( 'The Events Calendar PRO is a paid Add-On to our open source WordPress plugin %1$sThe Events Calendar%2$s. PRO offers a whole host of calendar features including recurring events, custom event attributes, saved venues and organizers, venue pages, advanced event admin and lots more.', 'rioc-common' ),
				...
				(object) array(
					'title' => __( 'Community Events', 'rioc-common' ),
					...
					'description' => __( 'Enable users to submit events to your calendar with Community Events. You can require user accounts or allow visitors to submit without an account. Want to make sure that nothing fishy is going on? Just turn on moderation. Decide if users can edit and manage their own events, or simply submit. Plus, no scary form setup! Just activate, configure the options & off you go.', 'rioc-common' ),
					'image' => 'images/app-shop-community.jpg',
				),
				(object) array(
					'title' => __( 'Community Tickets', 'rioc-common' ),
					...
					'description' => __( 'Enable Community Events organizers to offer tickets to their events. You can set flexible payment and fee options. They can even check-in attendees to their events! All of this managed from the front-end of your site without ever needing to grant access to your admin', 'rioc-common' ),
						'requires' => _x( 'Event Tickets Plus and Community Events', 'Names of required plugins for Community Tickets', 'rioc-common' ),
					'image' => 'images/app-shop-community-tickets.jpg',
				),
				(object) array(
					'title' => __( 'Event Tickets Plus', 'rioc-common' ),
					...
					'description' => sprintf(
						__( 'Event Tickets Plus allows you to sell tickets to your events using WooCommerce, Shopp, WP eCommerce, or Easy Digital Downloads. Use it on your posts and pages, or add %1$sThe Events Calendar%2$s and sell tickets from your events listings.', 'rioc-common' ),
						'<a href="http://m.tri.be/18vc">',
						'</a>'
					),
				...
				(object) array(
					'title' => __( 'Eventbrite Tickets', 'rioc-common' ),
				...
				(object) array(
					'title' => __( 'Facebook Events', 'rioc-common' ),
					...
					'description' => __( 'With the Facebook Events add-on, imported events are manually or automagically created as entries in The Events Calendar. Basic event data along with venue and organizer are populated appropriately. No more entering information in two places, or having to recreate someone else\'s listing for a public event you want to include on your WordPress calendar.', 'rioc-common' ),
					'image' => 'images/app-shop-facebook.jpg',
				),
				(object) array(
					'title' => __( 'iCal Importer', 'rioc-common' ),
					...
					'description' => __( 'The iCal Importer helps you keep your events calendar full of interesting events! You can import events from any website that publishes an iCal (aka ICS) feed and add them to your listings. The recurring import feature lets you keep your calendar brimming without manual oversight (though you can review every imported event if you like). Add filtering by keyword or geographic region and you can be sure that the kinds of events you get are the kinds you want.', 'rioc-common' ),
