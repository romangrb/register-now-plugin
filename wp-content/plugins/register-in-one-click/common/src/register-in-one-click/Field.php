...
if ( ! class_exists( 'Register_In_One_Click__Field' ) ) {
	...
	class Register_In_One_Click__Field {
		...
		public function doFieldStart() {
			$return = '<fieldset id="rioc-field-' . $this->id . '"';
			$return .= ' class="rioc-field rioc-field-' . $this->type;
			$return .= ( $this->error ) ? ' rioc-error' : '';
			$return .= ( $this->size ) ? ' rioc-size-' . $this->size : '';
		...
		public function radio() {
			...
			if ( is_array( $this->options ) ) {
				...
				$field .= '<span class="rioc-error">' . esc_html__( 'No radio options specified', 'rioc-common' ) . '</span>';
			}
			$field .= $this->doFieldDivEnd();
			$field .= $this->doFieldEnd();
		...
		public function checkbox_list() {
			...
			if ( is_array( $this->options ) ) {
				...
				$field .= '<span class="rioc-error">' . esc_html__( 'No checkbox options specified', 'rioc-common' ) . '</span>';
			}
			$field .= $this->doFieldDivEnd();
			$field .= $this->doFieldEnd();
		...
		public function dropdown() {
			...
			if ( is_array( $this->options ) && ! empty( $this->options ) ) {
				...
				$field .= '<span class="rioc-error">' . esc_html__( 'No select options specified', 'rioc-common' ) . '</span>';
			}
			$field .= $this->doFieldDivEnd();
			$field .= $this->doFieldEnd();
