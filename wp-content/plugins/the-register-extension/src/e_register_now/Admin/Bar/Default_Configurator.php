...
class E__Register__Now__Admin__Bar__Default_Configurator implements E__Register__Now__Admin__Bar__Configurator_Interface {
	...
	public function configure( WP_Admin_Bar $wp_admin_bar ) {
		...
		if ( current_user_can( 'edit_tribe_events' ) ) {
			$wp_admin_bar->add_menu( array(
				...
				'href'   => trailingslashit( get_admin_url() ) . 'post-new.php?post_type=' . 'tribe_events',
				'parent' => 'tribe-events-group',
			) );
		}
		...
		if ( current_user_can( 'edit_tribe_events' ) ) {
			$wp_admin_bar->add_menu( array(
				...
				'href'   => trailingslashit( get_admin_url() ) . 'edit.php?post_type=' . 'tribe_events',
				'parent' => 'tribe-events-group',
			) );
		}
