<div id="ern-app-shop" class="wrap">

	<div class="header">
		<h1><?php esc_html_e( 'e_register_now Event Add-Ons', 'ern-common' ); ?></h1>
	...
	<div class="content-wrapper">
		<div class="addon-grid">
			...
			foreach ( $products as $product ) {
				?>
				<div class="ern-addon<?php echo ( $i % 4 == 0 ) ? ' first ern-clearfix' : '';?>">
					<div class="thumb">
					...
					<div class="caption">
						...
						<div class="description">
							...
							if ( isset( $product->requires ) ) {
								?>
								<p><strong><?php esc_html_e( 'Requires:', 'ern-common' );?></strong> <?php echo esc_html( $product->requires );?></p>
								<?php
							}
							?>
						</div>
