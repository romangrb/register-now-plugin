 ...
 * default).
 */
class E__Register__Now__Admin__Notice__Plugin_Upgrade_Notice {
	/**
	 ...
	 *
	 *     #the-events-calendar-update .ern-plugin-update-message { ... }
	 */
	public function display_message() {
		$notice = wp_kses_post( $this->upgrade_notice );
		echo "<div class='ern-plugin-update-message'> $notice </div>";
	}
}